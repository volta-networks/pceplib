...
void test_pcep_msg_create_report()
{
    ...
    struct pcep_header* report_msg = pcep_msg_create_report(NULL);
    ...
    report_msg = pcep_msg_create_report(obj_list);
...
void test_pcep_msg_create_initiate()
{
    ...
    /* Should return NULL if obj_list is empty */
    struct pcep_header* initiate_msg = pcep_msg_create_initiate(NULL);
    ...
    dll_append(obj_list, srp);
    initiate_msg = pcep_msg_create_initiate(obj_list);
    CU_ASSERT_PTR_NULL(initiate_msg);
