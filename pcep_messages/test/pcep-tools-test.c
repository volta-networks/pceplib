...
char *pcep_open_cisco_pce_hexbyte_strs[] = {
    "20", "01", "00", "1c", "01", "10", "00", "18",
    "20", "3c", "78", "00", "00", "10", "00", "04",
    "00", "00", "00", "05", "00", "1a", "00", "04",
    "00", "00", "00", "0a"
};

uint16_t pcep_update_cisco_pce_hexbyte_strs_length = 100;
char *pcep_update_cisco_pce_hexbyte_strs[] = {
    "20", "0b", "00", "64", "21", "10", "00", "14",
    "00", "00", "00", "00", "00", "00", "00", "01",
    "00", "1c", "00", "04", "00", "00", "00", "01",
    "20", "10", "00", "18", "80", "00", "f0", "89",
    "00", "07", "00", "0c", "00", "00", "00", "09",
    "00", "03", "00", "04", "00", "00", "00", "01",
    "07", "10", "00", "28", "24", "0c", "10", "01",
    "04", "65", "50", "00", "0a", "0a", "0a", "05",
    "24", "0c", "10", "01", "04", "65", "20", "00",
    "0a", "0a", "0a", "02", "24", "0c", "10", "01",
    "04", "65", "10", "00", "0a", "0a", "0a", "01",
    "06", "10", "00", "0c", "00", "00", "00", "02",
    "41", "f0", "00", "00"
};

uint16_t pcep_report_cisco_pcc_hexbyte_strs_length = 148;
char *pcep_report_cisco_pcc_hexbyte_strs[] = {
    "20", "0a", "00", "94", "21", "10", "00", "14",
    "00", "00", "00", "00", "00", "00", "00", "00",
    "00", "1c", "00", "04", "00", "00", "00", "01",
    "20", "10", "00", "3c", "80", "00", "f0", "09",
    "00", "12", "00", "10", "0a", "0a", "0a", "06",
    "00", "02", "00", "0f", "0a", "0a", "0a", "06",
    "0a", "0a", "0a", "01", "00", "11", "00", "0d",
    "63", "66", "67", "5f", "52", "36", "2d", "74",
    "6f", "2d", "52", "31", "00", "00", "00", "00",
    "ff", "e1", "00", "06", "00", "00", "05", "dd",
    "70", "00", "00", "00", "07", "10", "00", "04",
    "09", "10", "00", "14", "00", "00", "00", "00",
    "00", "00", "00", "00", "00", "00", "00", "00",
    "07", "07", "01", "00", "05", "12", "00", "08",
    "00", "00", "00", "00", "05", "52", "00", "08",
    "00", "00", "00", "00", "06", "10", "00", "0c",
    "00", "00", "00", "02", "00", "00", "00", "00",
    "06", "10", "00", "0c", "00", "00", "01", "04",
    "41", "80", "00", "00"
};
...
void test_pcep_msg_read_pcep_open_cisco_pce()
{
    int fd = convert_hexstrs_to_binary(
            pcep_open_cisco_pce_hexbyte_strs, pcep_open_cisco_pce_hexbyte_strs_length);
    double_linked_list *msg_list = pcep_msg_read(fd);
    CU_ASSERT_PTR_NOT_NULL(msg_list);
    CU_ASSERT_EQUAL(msg_list->num_entries, 1);
    ...
    /* Open object */
    struct pcep_object_open *open = (struct pcep_object_open *) msg->obj_list->head->data;
    ...
    struct pcep_object_tlv_stateful_pce_capability *pce_cap_tlv =
            (struct pcep_object_tlv_stateful_pce_capability *) tlv_node->data;
    CU_ASSERT_EQUAL(pce_cap_tlv->header.type, PCEP_OBJ_TLV_TYPE_STATEFUL_PCE_CAPABILITY);
    ...
    CU_ASSERT_EQUAL(sr_pce_cap_tlv->header.type, PCEP_OBJ_TLV_TYPE_SR_PCE_CAPABILITY);
...
{
    int fd = convert_hexstrs_to_binary(
            pcep_update_cisco_pce_hexbyte_strs, pcep_update_cisco_pce_hexbyte_strs_length);
    double_linked_list *msg_list = pcep_msg_read(fd);
    CU_ASSERT_PTR_NOT_NULL(msg_list);
    CU_ASSERT_EQUAL(msg_list->num_entries, 1);
    ...
    struct pcep_message *msg = (struct pcep_message *) msg_list->head->data;
    CU_ASSERT_EQUAL(msg->msg_header->type, PCEP_TYPE_UPDATE);
    CU_ASSERT_EQUAL(msg->encoded_message_length, pcep_update_cisco_pce_hexbyte_strs_length);
    CU_ASSERT_EQUAL(msg->obj_list->num_entries, 4);
    ...
    CU_ASSERT_EQUAL(pst_tlv->header.type, PCEP_OBJ_TLV_TYPE_PATH_SETUP_TYPE);
    ...
    CU_ASSERT_EQUAL(sr_subobj_ipv4_node->ro_subobj.ro_subobj_type, RO_SUBOBJ_TYPE_SR);
    CU_ASSERT_FALSE(sr_subobj_ipv4_node->ro_subobj.flag_subobj_loose_hop);
    CU_ASSERT_EQUAL(sr_subobj_ipv4_node->nai_type, PCEP_SR_SUBOBJ_NAI_IPV4_NODE);
    ...
    /* Metric object */
    obj_node = obj_node->next_node;
    struct pcep_object_metric *metric = (struct pcep_object_metric *) obj_node->data;
...
{
    int fd = convert_hexstrs_to_binary(
            pcep_report_cisco_pcc_hexbyte_strs, pcep_report_cisco_pcc_hexbyte_strs_length);
    double_linked_list *msg_list = pcep_msg_read(fd);
    CU_ASSERT_PTR_NOT_NULL(msg_list);
    CU_ASSERT_EQUAL(msg_list->num_entries, 1);
    ...
    CU_ASSERT_EQUAL(msg->encoded_message_length, pcep_report_cisco_pcc_hexbyte_strs_length);
    ...
    CU_ASSERT_EQUAL(sym_path_name->header.type, PCEP_OBJ_TLV_TYPE_SYMBOLIC_PATH_NAME);
    CU_ASSERT_EQUAL(sym_path_name->header.encoded_tlv_length, 13);
    CU_ASSERT_EQUAL(sym_path_name->symbolic_path_name_length, 13);
    CU_ASSERT_EQUAL(strncmp(sym_path_name->symbolic_path_name, "cfg_R6-to-R1", 13), 0);
    ...
    /* LSPA object */
    obj_node = obj_node->next_node;
    struct pcep_object_lspa *lspa = (struct pcep_object_lspa *) obj_node->data;
    ...
    /* Bandwidth object 1 */
    obj_node = obj_node->next_node;
    struct pcep_object_bandwidth *bandwidth = (struct pcep_object_bandwidth *) obj_node->data;
    CU_ASSERT_EQUAL(bandwidth->header.object_class, PCEP_OBJ_CLASS_BANDWIDTH);
    CU_ASSERT_EQUAL(bandwidth->header.object_type, PCEP_OBJ_TYPE_BANDWIDTH_REQ);
