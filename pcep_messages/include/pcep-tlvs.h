...
{
    struct pcep_object_tlv_header header;
    double_linked_list *speaker_entity_id_list; /* list of uint32_t speaker entity ids */
};
...
/* Path Setup Type TLV, Used in RP and SRP Object. RFCs: 8408, draft-ietf-pce-segment-routing-16 */
#define SR_TE_PST 1
...
/* Path Setup Type Capability TLV, Used in Open Object. RFCs: 8408, draft-ietf-pce-segment-routing-16 */
...
/* SR PCE Capability sub-TLV, Used in Open Object. RFCs: draft-ietf-pce-segment-routing-16 */
...
struct pcep_object_tlv_stateful_pce_capability*    pcep_tlv_create_stateful_pce_capability(bool flag_u_lsp_update_capability, bool flag_s_include_db_version,
...
struct pcep_object_tlv_lsp_db_version*             pcep_tlv_create_lsp_db_version(uint64_t lsp_db_version);
struct pcep_object_tlv_speaker_entity_identifier*  pcep_tlv_create_speaker_entity_id(double_linked_list *speaker_entity_id_list);
...
struct pcep_object_tlv_ipv4_lsp_identifier*        pcep_tlv_create_ipv4_lsp_identifiers(struct in_addr *ipv4_tunnel_sender,
                                                                                        struct in_addr *ipv4_tunnel_endpoint,
                                                                                        uint16_t lsp_id, uint16_t tunnel_id,
                                                                                        struct in_addr *extended_tunnel_id);
struct pcep_object_tlv_ipv6_lsp_identifier*        pcep_tlv_create_ipv6_lsp_identifiers(struct in6_addr *ipv6_tunnel_sender,
                                                                                        struct in6_addr *extended_tunnel_id,
                                                                                        uint16_t lsp_id, uint16_t tunnel_id,
                                                                                        struct in6_addr *ipv6_tunnel_endpoint);
...
struct pcep_object_tlv_rsvp_error_spec*            pcep_tlv_create_rsvp_ipv6_error_spec(struct in6_addr *error_node_ip,
                                                                                        uint8_t error_code, uint16_t error_value);
