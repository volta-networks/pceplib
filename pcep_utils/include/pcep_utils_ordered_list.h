...
void *ordered_list_remove_first_node_equals2(ordered_list_handle *handle, void *data, ordered_compare_function func_ptr);

/* Remove the node "node_to_remove" and adjust the "prev_node" pointers accordingly,
